...
else
{
	...
	elseif(mysqli_num_rows($user_result) > 1) 
	{
		for ( $i = 0 ; $i < mysqli_num_rows($user_result) ; $i++ )
		{
			...
			echo "</tr>";
			echo "<table border='1' style='border-collapse: collapse;border-color: silver;'>";
			echo "<tr>"."<td align='center'>".'First Name'."</td>"."<td>".$row['First_name'] ."</td> "."</tr>";
			echo "<tr>"."<td align='center'>".'Last name'."</td>"."<td>".$row['Last_name'] ."</td> "."</tr>";
			echo "<tr>"."<td align='center'>".'Card id'."</td>"."<td><a href=view_borrower.php?&cardId=$Card_id>$Card_id"."</a>"."</td> "."</tr>";
